...
import FinishedAppDialog from "./FinishedBuyDialog";

interface BuyAdDialogProps {
    id: string;
    onBuy: () => void;
}

function BuyAd(props: BuyAdDialogProps) {
    const id = props.id;
    ...
    return (
        <>
            ...
            >
                <div className="flex flex-col items-center">
                    <FinishedAppDialog
                        buyerName={advertisement?.sellerId.name || "vendedor"}
                    />
                </div>
            </Backdrop>
        </>
