...
function AdDetailBuyer(props: AdDetailBuyerProps) {
  ...
  return (
    <div className="relative z-10 h-screen w-screen shrink-0 snap-center snap-always bg-black">
      ...
      <div className="pt-21 absolute -bottom-5 left-0 z-20 flex w-screen flex-col bg-gradient-to-t from-black">
        ...
        <div className="mt-6 flex w-screen flex-row items-center justify-center pb-12 font-outfit text-white">
          <button
